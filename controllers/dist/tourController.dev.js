    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 4:
          req.body.images = [];
          _context2.next = 7;
          return regeneratorRuntime.awrap(Promise.all(req.files.images.map(function _callee(file, idx) {
            var filename;
            return regeneratorRuntime.async(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    filename = "tour-".concat(req.params.id, "-").concat(Date.now(), "-").concat(idx + 1, ".jpeg");
                    _context.next = 3;
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          ...
          radius = unit === 'mi' ? distance / 3963.2 : distance / 6378.2;
...
exports.getDistances = catchAsync(function _callee6(req, res, next) {
  var _req$params2, latlng, unit, _latlng$split3, _latlng$split4, lat, lng, multiplier, dis;
